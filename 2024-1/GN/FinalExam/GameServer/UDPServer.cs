...
public sealed class UDPServer: IDisposable {
    ...
    public readonly Dictionary<uint, (long dbId, string name)> clientDbIdMap = new();
    ...
    public bool HasAnyClients => clients.Count > 0; 
    ...
    private void ReceiveThreadFunc() {
        while(true) {
            ...
            try {
                ...
                Console.WriteLine($"[UDP] Ignoring unexpected data receive error.");
                continue;
            }
